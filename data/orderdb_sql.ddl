...
INSERT INTO category(categoryName) VALUES ('Phone Technology'); 
INSERT INTO category(categoryName) VALUES ('Vehicle Technology'); 
INSERT INTO category(categoryName) VALUES ('Medical Technology');
INSERT INTO category(categryName) VALUES ('Clothing Technology');
INSERT INTO category(categoryName) VALUES ('Household Improvement Technology'); 
INSERT INTO category(categoryName) VALUES ('Advanced Food'); 
INSERT INTO category(categoryName) VALUES ('Misc./ Fun'); 



INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('10ft Wireless phone charger', 1, 'A 10ft wireless mesh that charges all phones within it',399.99); 
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Modified Mechanical St Jude Heart Valve', 3, 'A modified mechanical heart valve',19999.99); 
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Colour-changing Car (with invisibility-cloaking features)', 2, 'A car with colour-changing technology',250500.00); 
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Smart First-Aid Box Kit', 3, 'First-Aid Kit that detects low supplies and orders more automatically',420.99); 
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Size-adjustable Jacket', 4, 'Jacket size adjustable from sizes XXS through XXXL',200.99); 
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Handy Ladder', 5, 'A light-weight, foldable extension ladder',300.99); 
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Life-sized AI Interactive Doll', 7, 'A child-sized conversational talking and moving doll using AI technology',22999.99); 
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Self-hammering Nail Gun', 5, 'A nail gun with built-in hammering technology',100.00); 
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('All-in-One Flash Cooking Oven', 5, 'An oven that can cook any food within 15 minutes through baking, frying, boiling etc.', 10000.99); 
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Self-Composting Bin', 5, 'A bin that automatically composts food scraps', 1000.50); 
